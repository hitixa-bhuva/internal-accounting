  ...
  function drawBasic() {
    if ($("#column-chart1").length > 0) {
      var a = google.visualization.arrayToDataTable([
        ...
        b = {
          ...
          height: 400,
          width: "100%",
          colors: [ParisAdminConfig.primary, ParisAdminConfig.secondary, "#8DD4B4"],
        },
    ...
    if ($("#pie-chart1").length > 0) {
      ...
      var options = {
        ...
        width: "100%",
        height: 300,
        colors: ["#FFC38D", "#8DD4B4", "#a927f9", ParisAdminConfig.secondary, ParisAdminConfig.primary],
      };
    ...
    if ($("#pie-chart2").length > 0) {
      ...
      var options = {
        ...
        width: "100%",
        height: 300,
        colors: ["#FFC38D", "#a927f9", "#8DD4B4", ParisAdminConfig.secondary, ParisAdminConfig.primary],
      };
    ...
    if ($("#pie-chart4").length > 0) {
      ...
      var options = {
        ...
        colors: ["#94C4FF", ParisAdminConfig.primary, ParisAdminConfig.secondary, "#8DD4B4", "#a927f9", "#FFC38D", "#94C4FF", ParisAdminConfig.primary, "#FFC38D", "#8DD4B4", ParisAdminConfig.primary, ParisAdminConfig.secondary, "#8DD4B4", ParisAdminConfig.primary, "#a927f9", "#FFC38D", ParisAdminConfig.primary, ParisAdminConfig.primary, "#a927f9", ParisAdminConfig.secondary, ParisAdminConfig.primary, "#8DD4B4"],
      };
    ...
    if ($("#combo-chart").length > 0) {
      ...
      var options = {
        ...
        height: 500,
        width: "100%",
        colors: [ParisAdminConfig.primary, ParisAdminConfig.secondary, "#8DD4B4", "#a927f9", "#FFC38D"],
      };
    ...
    if ($("#area-chart1").length > 0) {
      ...
      var options = {
        ...
        width: "100%",
        height: 400,
        colors: [ParisAdminConfig.primary, ParisAdminConfig.secondary],
      };
    ...
    if ($("#area-chart2").length > 0) {
      ...
      var options = {
        ...
        width: "100%",
        height: 400,
        colors: [ParisAdminConfig.primary, ParisAdminConfig.secondary, "#8DD4B4", "#FFC38D"],
      };
  ...
  function drawChart() {
    ...
    var options = {
      ...
      gantt: {
        ...
        palette: [
          {
            color: ParisAdminConfig.primary,
            dark: ParisAdminConfig.secondary,
            light: "#047afb",
          },
        ],
      },
