(function ($) {
  ...
  if ($("#flot-basic-chart").length > 0) {
    ...
    $.plot("#flot-basic-chart", [a, c, d], {
      ...
      colors: ["#8DD4B4", "#8DD4B4", "#8DD4B4", "#8DD4B4"],
    });
  }
  ...
  function plotAccordingToChoices() {
    ...
    if (data.length > 0) {
      $.plot("#toggling-series-flot", data, {
        ...
        colors: [ParisAdminConfig.primary, "#FFC38D", "#a927f9", "#8DD4B4", ParisAdminConfig.secondary, "#94C4FF", "#FFC38D"],
      });
    }
  }
...
$(function () {
  ...
  var data = [
    { color: "#94C4FF", points: data1_points, data: data1, label: "data1" },
    ...
    { color: "#8DD4B4", points: data3_points, data: data4_errors },
  ];
...
$(function () {
  ...
  $.plot("#default-pie-flot-chart", data, {
    ...
    colors: [ParisAdminConfig.primary, "#8DD4B4", "#FFC38D", "#a927f9", "#94C4FF", "#6c757d", ParisAdminConfig.secondary],
  });
