(function ($) {
  ...
  $(".page-wrapper").attr("class", "page-wrapper " + localStorage.getItem("page-wrapper-Miami"));
  if (localStorage.getItem("page-wrapper-Miami") === null) {
...
$(document).ready(function () {
  function updateIconColor() {
      $(".sidebar-title").each(function () {
          let icon = $(this).prev("i.fa-thumbtack"); 
