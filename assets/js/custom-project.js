...
(function () {
  var summary_chat_option = {
    ...
    colors: [ParisAdminConfig.primary, "#54BA4A", "#FFC38D"],
  ...
  var taskOverview = {
    ...
    chart: {
      ...
      dropShadow: {
        ...
        left: 0,
        blur: 6,
        color: [ParisAdminConfig.primary, "#54BA4A"],
        opacity: 0.4,
      },
    },
    stroke: {
    ...
    colors: [ParisAdminConfig.primary, "#8DD4B4"],
    fill: {
      type: "gradient",
      gradient: {
        shade: "light",
      ...
      discrete: [
        {
          seriesIndex: 0,
          dataPointIndex: 3,
          fillColor: ParisAdminConfig.primary,
  ...
  var monthlyExpense = {
    ...
    colors: ["var(--theme-default)", "rgba(57 ,73 ,171, 0.13)", "rgba(57 ,73 ,171, 0.33)", "rgba(57 ,73 ,171, 0.62)", "rgba(57 ,73 ,171, 0.09)"],
    responsive: [
      {
        breakpoint: 1698,
        options: {
  ...
  var projectChart = {
    ...
    colors: [ParisAdminConfig.primary, "#94C4FF", "#FFC38D", "#8DD4B4"],
