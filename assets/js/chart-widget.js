...
(function () {
  ...
  var optionslinechart = {
    ...
    colors: [ParisAdminConfig.primary],
    series: [
      {
  ...
  var optionscolumnchart = {
    ...
    colors: [ParisAdminConfig.secondary, "#8DD4B4", ParisAdminConfig.primary],
    fill: {
      type: "gradient",
      gradient: {
        shade: "light",
      ...
      xaxis: [
        {
          ...
          strokeDashArray: 0,
          borderColor: ParisAdminConfig.primary,
          label: {
            borderColor: ParisAdminConfig.primary,
            offsetY: 20,
            style: {
              color: "#fff",
              background: ParisAdminConfig.primary,
            },
            text: "Anno Test",
          },
        },
  ...
  var optionsuserchart = {
    ...
    colors: [ParisAdminConfig.primary, ParisAdminConfig.secondary, "#8DD4B4", "#544fff"],
    title: {
  ...
  var optionscandlestickchart = {
    ...
    plotOptions: {
      candlestick: {
        colors: {
          upward: ParisAdminConfig.primary,
          downward: "#94C4FF",
        },
      },
    },
  ...
  var optionsCircle = {
    ...
    colors: [ParisAdminConfig.secondary, ParisAdminConfig.primary, "#8DD4B4"],
    responsive: [
      {
        breakpoint: 767,
        options: {
  ...
  var optionsProgress1 = {
    ...
    plotOptions: {
      bar: {
        ...
        barHeight: "15%",
        colors: {
          backgroundBarColors: [ParisAdminConfig.primary],
    ...
    fill: {
      ...
      type: "gradient",
      gradient: {
        gradientToColors: [ParisAdminConfig.primary],
      },
    },
    series: [
      {
  ...
  var optionsProgress2 = {
    ...
    plotOptions: {
      bar: {
        ...
        barHeight: "15%",
        colors: {
          backgroundBarColors: [ParisAdminConfig.secondary],
          backgroundBarOpacity: 0.2,
